...
```bash
curl -X GET "https://api.apiverve.com/v1/gravatarlookup?param=value" \
...
📚 **Full API Documentation:** [https://docs.apiverve.com/ref/gravatarlookup](https://docs.apiverve.com/ref/gravatarlookup)

---

## Use Cases

Common use cases for the Gravatar Lookup API:
