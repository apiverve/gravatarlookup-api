...
const (
	baseURL        = "https://api.apiverve.com/v1/gravatarlookup"
	defaultTimeout = 30 * time.Second
)

// Client is the Gravatar Lookup API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Gravatar Lookup API client.
...
// Execute makes a request to the Gravatar Lookup API with typed parameters.
//
