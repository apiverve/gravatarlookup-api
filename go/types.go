// Package gravatarlookup provides a Go client for the Gravatar Lookup API.
//
// For more information, visit: https://apiverve.com/marketplace/gravatarlookup?utm_source=go&utm_medium=readme
package gravatarlookup
...
// Request contains the parameters for the Gravatar Lookup API.
//
// Parameters:
//   - email (required): string - The email address to lookup the Gravatar profile of [format: email]
type Request struct {
...
// ResponseData contains the data returned by the Gravatar Lookup API.
type ResponseData struct {
	ProfileUrl string `json:"profileUrl"`
	ThumbnailUrl string `json:"thumbnailUrl"`
	Photos []PhotosItem `json:"photos"`
	DisplayName string `json:"displayName"`
	AboutMe string `json:"aboutMe"`
	CurrentLocation string `json:"currentLocation"`
	Company string `json:"company"`
	ContactInfo []ContactInfoItem `json:"contactInfo"`
	Accounts []AccountsItem `json:"accounts"`
	Username string `json:"username"`
}

// PhotosItem represents an item in the Photos array.
type PhotosItem struct {
	Value string `json:"value"`
	Type string `json:"type"`
}

// ContactInfoItem represents an item in the ContactInfo array.
type ContactInfoItem struct {
	Type string `json:"type"`
	Value string `json:"value"`
}

// AccountsItem represents an item in the Accounts array.
