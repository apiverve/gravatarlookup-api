...
namespace APIVerve.API.GravatarLookup
{
    ...
    /// <summary>
    /// Client for the GravatarLookup API
    /// </summary>
...
#endif
    {
        ...
        public GravatarLookupAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public GravatarLookupAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public GravatarLookupAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        private void ValidateParams(GravatarLookupQueryOptions options)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(GravatarLookupQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(GravatarLookupQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(GravatarLookupQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(GravatarLookupQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(GravatarLookupQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
