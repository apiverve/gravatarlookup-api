...
```gradle
dependencies {
    implementation 'com.github.apiverve:gravatarlookup-api:1.1.14'
}
```
...
```java
import com.apiverve.gravatarlookup.GravatarLookupAPIClient;
import com.apiverve.gravatarlookup.APIResponse;
import com.apiverve.gravatarlookup.APIException;

// Initialize the client
GravatarLookupAPIClient client = new GravatarLookupAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("email", "hello@apiverve.com");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/gravatarlookup](https://docs.apiverve.com/ref/gravatarlookup)
...
- **Documentation:** [https://docs.apiverve.com/ref/gravatarlookup](https://docs.apiverve.com/ref/gravatarlookup)
- **Issues:** [GitHub Issues](https://github.com/apiverve/gravatarlookup-api/issues)
