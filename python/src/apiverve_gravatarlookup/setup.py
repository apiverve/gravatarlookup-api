...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/gravatarlookup',
        'Source': 'https://github.com/apiverve/gravatarlookup-api',
        'Bug Tracker': 'https://github.com/apiverve/gravatarlookup-api/issues'
    },
    classifiers=[
