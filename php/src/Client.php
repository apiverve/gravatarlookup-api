...
namespace APIVerve\Gravatarlookup;
...
/**
 * Client for the Gravatar Lookup API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/gravatarlookup?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/gravatarlookup';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\GravatarlookupClient] {$message}\n";
        }
    }
}
